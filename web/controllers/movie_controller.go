...
func (c *MovieController) Get() (results []model.Movie) {
...
func (c *MovieController) GetBy(id int64) (movie model.Movie, found bool) {
...
func (c *MovieController) PutBy(ctx iris.Context,id int64) (model.Movie, error) {
